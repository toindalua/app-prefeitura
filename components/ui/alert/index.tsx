...
const alertStyle = tva({
  base: 'items-center py-3 px-4 rounded-full flex-row gap-2 border-outline-100 bg-[rgb(var(--color-background-muted)/0.1)]',

  variants: {
    action: {
      error: 'bg-[rgb(var(--color-background-error)/1)]',
      warning: 'bg-[rgb(var(--color-background-warning)/1)]',
      success: 'bg-[rgb(var(--color-background-success)/1)]',
      info: 'bg-[rgb(var(--color-background-info)/1)]',
      muted: 'bg-[rgb(var(--color-background-muted)/1)]',
    },

    variant: {
      solid: '',
      outline: 'border bg-[ rgba(255, 0, 0, 0.5) ] backdrop-blur-sm',
    },
  },
});
